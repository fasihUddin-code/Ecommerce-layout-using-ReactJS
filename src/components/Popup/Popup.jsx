    ...
    <>
      {
        orderPopup && <div className='popup'>
          ...
          >
            <div
              className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 shadow-md bg-white
            ...
            >
              ...
              >
                ...
                <div className="flex justify-center">
                  <button
                    className='bg-gradient-to-r from-primary to-secondary hover:scale-105 duration-200 text-white py-1 px-4 
                    rounded-full'
